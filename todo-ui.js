...
class UiRoof {
	...
	const invsys = sys.invsysGetOrNu(invsysClas);
...
class UiSys {
	...
	const partTabElem = temClone('partTab_tem')
	this.partTabParentElem.replaceChildren(partTabElem);
	this.sys = new Sys(new UiPartTab(partTabElem), this.railGroupDiagVElem);
...
function uiBodyOnload() {
	...
	RackNone,
	IronRidgeXRRack10Camo,
	IronRidgeXRRack10Stopper,
	IronRidgeXRRack100Camo,
	IronRidgeXRRack100Stopper,
    );
